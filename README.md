...
| Metrics | **Bionetta (UltraGroth)** | [`ddkang/zkml`](https://github.com/ddkang/zkml) | [EZKL](https://ezkl.xyz/) | [`deep-prove`](https://github.com/Lagrange-Labs/deep-prove) | 
| --------- | -------- | ------------ | ----------- | ---- |
| Proof Size (KB) | **1.20** | 5.60 | 18.90 | 4555.00 |
| Verification Key Size (KB) | **3.78** | 4096.50 | 2049.00 | 0 |
| Proving Key Size (KB) | **156.20** | 4226.20 | 8454.20 | 0 |
| Proving Time (s) | **1.79** | 230.72 | 663.95 | 2.52 |
| Verification Time (s) | **0.005** | 0.009 | 2.32 | 0.11 |

*_For testing, we used Intel i5-10400f CPU and 32GB of RAM_
